...
<div class="index_container">
    ...
    <div class="newsroom">
        ...
        <marquee class="marquee_news" scrolldelay="20">
            <p class="newsfeed">
                <span>WELCOME,we hope you like our services</span>
                <!--<span>SBI cuts deposit rates; PPF to fetch lower interest rate. </span>
                <span>No, it is not mandatory to link your bank account with CITIZENSHIP card</span>-->
            </p>
        </marquee>
    </div><br><br> 
...
<div class="news_events">
    <h4>Tips | Updates | Events</h4><br>
        <ul>
            <p>First, open an account. Then apply for a debit card to get further details.</p><br>
    ...
    <div class="online_services">
        ...
        <p>engineering students at ENET'COM 
</p></div>
